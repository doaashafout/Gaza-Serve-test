...
⚠️ الأهم جداً: id_number هو رقم الهوية المكون من 9 أرقام والمطبوع بجانب عبارة "رقم الهوية" أو "מספר הזהות". تجاهل تماماً أي أرقام أخرى.

📌 اقرأ الرقم حرفياً digit-by-digit ومن اليسار لليمين. تأكد من كل رقم على حدة. إذا كان الرقم مكتوباً متقطعاً بمسافات (مثل "4 0814714 8")، اجمع الأرقام معاً. دقّق خاصة بآخر 3 أرقام فغالباً ما تكون غير واضحة.`;
