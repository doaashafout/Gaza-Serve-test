...
## الخدمات المتاحة:
• 🧹 تنظيف منزل - كنس، ترتيب، تعقيم، غسيل سجاد، تلميع زجاج
...
• 🛠️ صيانة عامة - نجارة، دهان، بناء، حدادة، تركيب زجاج، تصليح عام
• 🖌️ دهان - دهان جدران، دهان أسقف، ديكورات
...
"أتفهم مشكلتك تماماً! 🤝 سأجد لك فني متخصص في أقرب وقت.
يسرني مساعدتك في إيجاد فني صيانة متخصص.
...
🧹 تنظيف منزل | ⚡ كهرباء | 🚰 سباكة | 🛠️ صيانة عامة | 🖌️ دهان
...
const AI_FUNCTIONS = [
  {
    ...
    parameters: {
      ...
      properties: {
        category: {
          type: 'string',
          enum: ['تنظيف منزل', 'كهرباء', 'سباكة', 'صيانة عامة', 'دهان'],
          description: 'اختر التخصص بدقة: تنظيف منزل للكنس والترتيب والتعقيم. كهرباء للأسلاك والفيش واللمبات والأعطال الكهربائية. سباكة للمياه والمواسير والمغاسل والأحواض. صيانة عامة للنجارة والدهان والبناء والحدادة. دهان للجدران والأسقف والديكورات.',
        },
        location: {
          type: 'string',
    ...
    messages: [
      {
        ...
        content: 'أنت مساعد لتصنيف طلبات الصيانة. حلل النص وأعد JSON:\n' +
          ...
          '{"type": "request", "category": "التخصص (تنظيف منزل/كهرباء/سباكة/صيانة عامة/دهان)", "location": "المنطقة"}\n\n' +
          'إذا كان النص تحية، سؤال، أو طلب تسجيل كفني:\n' +
          '{"type": "other"}\n\n' +
          'أمثلة:\n' +
          '"بيتي وسخ بدي حد ينظفه" → {"type": "request", "category": "تنظيف منزل", "location": ""}\n' +
          '"مرحبا" → {"type": "other"}\n' +
