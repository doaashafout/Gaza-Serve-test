...
const PIE_COLORS = ['#00d4ff', '#7b2ff7', '#ffd700', '#00ff88', '#ff6666', '#ff8800'];
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-gray-500 border-b border-gray-800">
                    ...
                    <th className="text-right py-2 px-2">الموقع</th>
                ...
                <tbody>
                  {stats.recentRequests.map(r => (
                    <tr key={r.id} className="border-b border-gray-800/50 text-gray-300 hover:bg-gray-800/50">
                      ...
                      <td className="py-2 px-2 text-gray-500">{r.created}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
